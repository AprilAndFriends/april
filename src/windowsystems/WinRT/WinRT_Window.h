...
#define WINRT_SNAPPED_VIEW_WIDTH (320 * april::getSystemInfo().displayDpi / 96) // as defined by Microsoft
#define WINRT_SNAPPED_VIEW_UNUSED ((320 + 22) * april::getSystemInfo().displayDpi / 96) // as defined by Microsoft
