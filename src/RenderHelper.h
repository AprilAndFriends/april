...
namespace april
{
	...
	public:
		...
		virtual bool drawRect(cgrectf rect, const Color& color);
		virtual bool drawFilledRect(cgrectf rect, const Color& color);
		virtual bool drawTexturedRect(cgrectf rect, cgrectf src);
		virtual bool drawTexturedRect(cgrectf rect, cgrectf src, const Color& color);
