...
namespace april
{
	...
	enum Key
	{
		...
		// codes obtained from "kdext.h"
		AK_UNKNOWN = 0x400000FF,
		AK_NONE = 0,
	
		// first several VKs are unneeded
		// they are mouse related, or ctrl+break
		AK_LBUTTON = 0x40000001,
		AK_RBUTTON = 0x40000002,
		AK_CANCEL = 0,
		AK_MBUTTON = 0x40000004,
		AK_WHEELUP = 0,
		AK_WHEELDN = 0,
		AK_DOUBLETAP = 0, // touchscreen only

		// most common keys
		AK_BACK = 0x40000008,
		AK_TAB = 0x40000009,
		AK_CLEAR = 0,
		AK_RETURN = 0x4000000D,
		AK_SHIFT = 0x40000010,
		AK_CONTROL = 0x40000011,
		AK_MENU = 0x40000012, // alt key 
		AK_PAUSE = 0x40000013, // multimedia pause key 
		AK_CAPITAL = 0x40000014, // caps lock
		...
		// Mac CMD keys
		AK_LCOMMAND = 0x40000011,
		AK_RCOMMAND = 0x40000011,
		...
		// right side of the "control block"
		// commonly above cursor keys
		AK_PRIOR = 0x40000021, // page up
		AK_NEXT = 0x40000022, // page down
		AK_END = 0x40000023, 
		AK_HOME = 0x40000024,
		...
		// some less common keys
		AK_SELECT = 0, // select key
		AK_PRINT = 0, // print key
		AK_EXECUTE = 0, // execute key
		AK_SNAPSHOT = 0, // print screen key

		// left side of "control block" commonly
		// above cursor keys, plus the help key
		// help key is NOT F1
		AK_INSERT = 0x4000002D,
		AK_DELETE = 0x4000002E,
		AK_HELP = 0,
		...
		// numpad
		AK_NUMPAD0 = 0x40000060,
		AK_NUMPAD1 = 0x40000061,
		AK_NUMPAD2 = 0x40000062,
		AK_NUMPAD3 = 0x40000063,
		AK_NUMPAD4 = 0x40000064,
		AK_NUMPAD5 = 0x40000065,
		AK_NUMPAD6 = 0x40000066,
		AK_NUMPAD7 = 0x40000067,
		AK_NUMPAD8 = 0x40000068,
		AK_NUMPAD9 = 0x40000069,
		AK_MULTIPLY = 0x4000006A,
		AK_ADD = 0x4000006B,
		AK_SEPARATOR = 0,
		AK_SUBTRACT = 0x4000006D,
		AK_DECIMAL = 0x4000006E,
		AK_DIVIDE = 0x4000006F,
		...
		// some more lock keys
		AK_NUMLOCK = 0x40000090,
		AK_SCROLL = 0x40000091,

		// specific left-and-right-shift keys
		AK_LSHIFT = 0x40000010,
		AK_RSHIFT = 0x40000010,
		AK_LCONTROL = 0x40000011,
		AK_RCONTROL = 0x40000011,
		AK_LMENU = 0x40000012,
		AK_RMENU = 0x40000012,
		
		// browser control keys
		AK_BROWSER_BACK = 0,
		AK_BROWSER_FORWARD = 0,
		AK_BROWSER_REFRESH = 0,
		AK_BROWSER_STOP = 0,
		AK_BROWSER_SEARCH = 0,
		AK_BROWSER_FAVORITES = 0,
