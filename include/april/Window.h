...
namespace april
{
	...
	public:
		...
		virtual HL_INLINE void setTitle(chstr value) { this->title = value; }
		virtual HL_INLINE bool isCursorVisible() { return this->cursorVisible; }
		virtual HL_INLINE void setCursorVisible(bool value) { this->cursorVisible = value; }
		virtual HL_INLINE void setCursorFilename(chstr value) { this->cursorFilename = value; }
		...
		DEPRECATED_ATTRIBUTE HL_INLINE bool isTouchEnabled() { return (this->inputMode == TOUCH); }
		...
		virtual HL_INLINE void beginKeyboardHandling() { }
		virtual HL_INLINE void terminateKeyboardHandling() { }
		
		virtual HL_INLINE bool isRotating() { return false; } // iOS/Android devices for example
		virtual HL_INLINE hstr getParam(chstr param) { return ""; } // TODOaa - this should be refactored
		virtual HL_INLINE void setParam(chstr param, chstr value) { } // TODOaa - this should be refactored
		...
		static HL_INLINE void setLaunchCallback(void (*callback)(void*)) { msLaunchCallback = callback; }
