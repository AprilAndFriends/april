...
namespace april
{
	...
	void OpenGL1_RenderSystem::reset()
	{
		OpenGL_RenderSystem::reset();
		this->state.reset();
	...
	void OpenGL1_RenderSystem::setTextureColorMode(ColorMode textureColorMode, unsigned char alpha)
	{
		this->state.colorMode = textureColorMode;
		this->state.colorModeAlpha = alpha;
	}

	void OpenGL1_RenderSystem::_setTextureColorMode(ColorMode textureColorMode, unsigned char alpha)
	{
	...
	void OpenGL1_RenderSystem::setTextureFilter(Texture::Filter textureFilter)
	{
		this->state.textureFilter = textureFilter;
	}

	void OpenGL1_RenderSystem::_setTextureFilter(Texture::Filter textureFilter)
	{
	...
	void OpenGL1_RenderSystem::setTextureAddressMode(Texture::AddressMode textureAddressMode)
	{
		this->state.textureAddressMode = textureAddressMode;
	}

	void OpenGL1_RenderSystem::_setTextureAddressMode(Texture::AddressMode textureAddressMode)
	{
	...
	Texture* OpenGL1_RenderSystem::getRenderTarget()
	{
		return NULL;
	}
	
	void OpenGL1_RenderSystem::setRenderTarget(Texture* texture)
	{
		// TODO
	}
	
	void OpenGL1_RenderSystem::setTexture(Texture* texture)
	{
		this->activeTexture = (OpenGL1_Texture*)texture;
	...
	void OpenGL1_RenderSystem::setPixelShader(PixelShader* pixelShader)
	{
		hlog::warn(april::logTag, "Pixel shaders are not implemented!");
	}

	void OpenGL1_RenderSystem::setVertexShader(VertexShader* vertexShader)
	{
		hlog::warn(april::logTag, "Vertex shaders are not implemented!");
	}

	void OpenGL1_RenderSystem::setResolution(int w, int h)
	{
		hlog::warn(april::logTag, "setResolution() is not implemented!");
	}

	void OpenGL1_RenderSystem::_applyStateChanges()
	{
	...
	void OpenGL1_RenderSystem::_setClientState(unsigned int type, bool enabled)
	{
		enabled ? glEnableClientState(type) : glDisableClientState(type);
	}

	void OpenGL1_RenderSystem::bindTexture(unsigned int textureId)
	{
	...
	Texture* OpenGL1_RenderSystem::createTexture(int w, int h, unsigned char* rgba)
	{
		return new OpenGL1_Texture(w, h, rgba);
	}
	
	Texture* OpenGL1_RenderSystem::createTexture(int w, int h, Texture::Format format, Texture::Type type, Color color)
	{
		return new OpenGL1_Texture(w, h, format, type, color);
	}

	PixelShader* OpenGL1_RenderSystem::createPixelShader()
	{
		hlog::warn(april::logTag, "Pixel shaders are not implemented!");
		return NULL;
	}

	PixelShader* OpenGL1_RenderSystem::createPixelShader(chstr filename)
	{
		hlog::warn(april::logTag, "Pixel shaders are not implemented!");
		return NULL;
	}

	VertexShader* OpenGL1_RenderSystem::createVertexShader()
	{
		hlog::warn(april::logTag, "Vertex shaders are not implemented!");
		return NULL;
	}

	VertexShader* OpenGL1_RenderSystem::createVertexShader(chstr filename)
	{
		hlog::warn(april::logTag, "Vertex shaders are not implemented!");
		return NULL;
	}

	void OpenGL1_RenderSystem::clear(bool useColor, bool depth)
	{
		GLbitfield mask = 0;
		if (useColor)
		{
	...
	void OpenGL1_RenderSystem::clear(bool depth, grect rect, Color color)
	{
	...
	void OpenGL1_RenderSystem::setMatrixMode(unsigned int mode)
	{
